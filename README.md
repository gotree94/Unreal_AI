...
```bash
# Windows (PowerShell)
python -m venv ue_ml_env
.\ue_ml_env\Scripts\Activate.ps1

# Linux
python3 -m venv ue_ml_env
source ue_ml_env/bin/activate
```
...
# 유틸리티
pip install protobuf==3.20.3 grpcio==1.53.2 numpy pandas matplotlib
```
...
# 설치된 패키지 확인
pip list | grep -E "mlagents|schola|torch|stable"
```
